...
make_fake_root() {
  ...
  # fm-tmux-lib.sh sources fm-composer-lib.sh (its shared idle/busy classifier),
  # so the fake bin needs it too or the kill dispatch aborts on a missing sibling.
